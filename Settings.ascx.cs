...
namespace Christoc.Modules.dnn_groupdocs_viewer_dotnet
{
    ...
    /// 
    /// Because the control inherits from dnn_groupdocs_viewer_dotnetSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : dnn_groupdocs_viewer_dotnetModuleSettingsBase
    {

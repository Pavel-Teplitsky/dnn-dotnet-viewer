...
namespace Christoc.Modules.dnn_groupdocs_viewer_dotnet.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.dnn_groupdocs_viewer_dotnet.Data.SqlDataprovider,dnn_groupdocs_viewer_dotnet";
